...
[//]: # "Image References"
[image1]: ./output_images/calibration.jpg "Calibration Sample"
[image2]: ./output_images/undistort_in.jpg "Undistorted Input"
[image3]: ./output_images/undistort_out.jpg "Undistorted Output"
[image4]: ./output_images/undistort_combo.jpg "Undistortion Visualized"
[imageroi]: ./output_images/roi.jpg "ROI"
[image5]: ./output_images/binary_thresh.gif "Binary Thresholding"
[image6]: ./output_images/bird&#39;s_eye.jpg "Warp Example"
[image7]: ./output_images/lane_detect.jpg "Lane Detection"
[image8]: ./output_images/lane_track.jpg "Lane Tracking"
[image9]: ./output_images/final_output_1.jpg "Output 1"
[image10]: ./output_images/final_output_2.jpg "Output 2"
[image11]: ./output_images/no_detect.jpg "Output 3"
[video1]: ./project_video_out.avi "Project Video Output"
[video2]: ./challenge_video_out.avi "Challenge Video Output"
...
- Here we show the effect of calibration and undistortion on a calibration image.
  ![alt text][image1]
...
- This is done by `laneUtils.undistort` called in `_process` function in `ALF.py`. Here is a sample output. The third figure shows the effect of distortion on the first image.
...
- All further processing is done on this reducec ROI image.
  ![alt text][imageroi]
...
- Here is a sample output of the various steps the algorithm takes. The GIF shows the thresholding over 11 steps. The final image is the one accepted for lane detection by the algorithm. 
...
- To calculate the RoC and position of car in metric units, we need to find the meters/ pixels scale in x and y axis.
  ...
  - For the current case,
    -  `scale_X = 3.7/420 #(meters/pixels)`
    -  `scale_Y = 3.048/33 #(meters/pixels)`
- The *minimum RoC and width of the lane* are also considered to reject or keep the detected lanes. This is done in the function `Car.sanity_check()`.
...
- The annotations are then added onto the final image in `Car.annotate()`.
...
#### 1. Here's a [link to the project video result][video1]. Another more [challenging video can be found here][video2].

[^Note #1: ]: There seems to be some issue when playing the video in native Ubuntu video player. Please use VLC media player
